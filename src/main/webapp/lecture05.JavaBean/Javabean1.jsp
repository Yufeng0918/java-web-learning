<%@ page language="java" import="lecture05.javaBean.Person"
	pageEncoding="UTF-8"%>
<%
...
<body>
	...
	<jsp:useBean id="person" class="lecture05.javaBean.Person" scope="application"></jsp:useBean>
	...
	<jsp:forward page="/lecture05.JavaBean/Javabean2.jsp"></jsp:forward>
</body>
</html>
